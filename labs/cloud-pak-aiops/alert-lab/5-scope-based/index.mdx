...
- From the **Group alerts based on scope** page:
  ...
  - Under **Policy details**, set the **Policy name** as "Group Alerts coming
    from 2 Locations by Location-Service"
